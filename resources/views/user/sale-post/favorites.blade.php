...
<head>
    ...
    <style>
        ...
        .post-card:hover .image-wrapper img { transform: scale(1.1); }
        ...
        .stats-item { font-size: 0.75rem; font-weight: 700; color: #636e72; }
        .stats-item i { color: var(--primary); margin-right: 4px; }
...
@php
    $convertImage = function($path) {
        if (!$path) return 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1000&q=80';
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div class="nav-actions">
                ...
                <a href="{{ route('favorite.index') }}" class="btn-custom btn-primary-custom"><i class="fas fa-heart"></i> Yêu thích</a>
        ...
        <p class="opacity-75 fw-500">Bạn đã lưu <span class="text-info fw-700">{{ $favorites->total() }}</span> bất động sản</p>
    </div>
</header>
            ...
            <div class="post-card">
                <div class="image-wrapper">
                    ...
                    <a href="{{ route('create-sale-show', $post->id) }}">
                        <img src="{{ $convertImage($imagePath) }}" alt="{{ $post->title }}" onerror="this.src='https://via.placeholder.com/400x300?text=EstateHub'">
                    </a>
                </div>
                ...
                <div class="p-4">
                    ...
                    <h6 class="fw-700 mb-3">
                        <a href="{{ route('create-sale-show', $post->id) }}" class="text-decoration-none text-dark text-truncate d-block">
                            {{ $post->title }}
                        </a>
                    </h6>

                    <p class="text-muted small mb-3">
                        <i class="fas fa-map-marker-alt me-1 text-danger"></i> {{ Str::limit($post->address, 35) }}
                    </p>

                    <div class="stats-group">
                        <span class="stats-item"><i class="fas fa-bed"></i> {{ $post->bedrooms ?? 0 }} PN</span>
                        <span class="stats-item"><i class="fas fa-bath"></i> {{ $post->bathrooms ?? 0 }} PT</span>
        ...
        <div class="col-12">
            <div class="empty-state">
                ...
                <p class="text-muted mb-4 mx-auto" style="max-width: 450px;">
                    Hãy lưu lại những căn nhà bạn ưng ý để dễ dàng so sánh và liên hệ chủ nhà bất cứ khi nào bạn cần.
                </p>
