    ...
    <div class="container-fluid p-0">
        <div class="d-flex">
            <div class="sidebar p-3 text-white" id="admin-sidebar">
                <h4 class="text-center mt-3 mb-4 fw-bold border-bottom pb-3 text-uppercase tracking-wider">Real Estate
                </h4>
                ...
                <div class="nav flex-column nav-pills" id="admin-sidebar-nav">
                    ...
                    <div class="mt-4 pt-4 border-top">
                        ...
                        <a href="{{ url('/home') }}" class="nav-link ">
                            <i class="fas fa-home me-3"></i> <span>Về trang chủ</span>
                        </a>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit"
                                class="btn btn-outline-danger btn-sm w-100 border-0 text-start d-flex align-items-center nav-link">
